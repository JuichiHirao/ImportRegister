...
class DbMysql:
    ...
    def get_url_jav2s(self, p_number):

        sql = 'SELECT id, title, url FROM jav2 WHERE title like %s '

        self.cursor.execute(sql, (p_number, ))
    ...
    def update_jav_package(self, id, package_filename):
